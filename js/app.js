...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${images}></img>
      ...
      <h6> <i class="fas fa-star filled"></i>
      <i class="fas fa-star filled"></i>
      <i class="fas fa-star filled"></i>
      <i class="fas fa-star filled"></i>
      <i class="fas fa-star empty"></i> <br> <br> Rating: ${product.rating.rate}</h6>
...
const productDetails = () => {
  ...
  fetch(url)
    ...
    .then(data => {
      ...
      displaySingleProductDetails(data.products[0]);
    });
}
const displaySingleProductDetails = product => {
  ...
  singleProduct.classList.add('Modal');
  singleProduct.innerHTML = `
    <h5 class="text-center">Product Id: ${product.productId}</h5>
    <h5 class="text-center">Quantity: ${product.quantity}</h5>
    `;
  productDetails.appendChild(singleProduct);
}
